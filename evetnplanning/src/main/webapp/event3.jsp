...
<header>
    ...
    <div class="user">
        <img src="image/Wedding-Table-Arrangements-Grand-Nikko-Bali.jpg" alt="">
        <h3 class="name">wedding</h3>
        <p class="post">arrangements</p>
    </div>
...
<section class="home" id="home">
    ...
    <h3>HI THERE !</h3>
    <h1>we're <span>weda rrangers</span></h1>
    <p>
    </p>
...
<div class="row">
    ...
    <div class="info">
        <h3> <span> Group name : </span> wedders </h3>
...
<div class="row">
    ...
    <form action="" id="form">
        ...
        <button type="submit" class="btn"> book <i class="fas fa-paper-plane"></i> 
        </button>
