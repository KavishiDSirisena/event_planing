...
<header>
    ...
    <div class="user">
        <img src="image/photo_2022-10-21_17-20-13.jpg" alt="">
        <h3 class="name">Birthday</h3>
...
<section class="home" id="home">
    ...
    <h3>HI THERE !</h3>
    <h1><span>birthdays </span></h1>
    <p>A birthday party is much more than a simple blowing out of candles. It is a combination of delicious food, good music and of course, good times! We are dedicated in making your birthday a memorable one by delivering a personalized experience.
    </p>
...
<div class="row">
    ...
    <div class="info">
        <h3> <span> Group name : </span> birthday buddies </h3>
        <h3> <span> Group members : </span> 10 </h3> 
    </div>
